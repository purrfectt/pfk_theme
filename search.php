<?php get_header(); ?>
			...
			<div id="content" class="clearfix row-fluid">
				...
				<div id="main" class="span8 clearfix" role="main">
					...
					<div class="page-header"><h1><span><?php _e("Search Results for","pfk"); ?>:</span> <?php echo esc_attr(get_search_query()); ?></h1></div>
					...
					<article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> role="article">
						...
						<section class="post_content">
							<?php the_excerpt('<span class="read-more">' . __("Read more on","pfk") . ' "'.the_title('', '', false).'" &raquo;</span>'); ?>
