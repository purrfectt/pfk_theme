...
function pfk_rss_dashboard_widget() {
...
function pfk_custom_dashboard_widgets() {
	wp_add_dashboard_widget('pfk_rss_dashboard_widget', 'Recently on Themble (Customize on admin.php)', 'pfk_rss_dashboard_widget');
	/*
...
add_action('wp_dashboard_setup', 'pfk_custom_dashboard_widgets');
