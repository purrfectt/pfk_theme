						...
						<div class="container-fluid nav-container">
							<nav role="navigation">
								...
								<div class="nav-collapse">
									<?php pfk_main_nav(); // Adjust using Menus in Wordpress Admin ?>
								</div>
							...
							<form class="navbar-search pull-right" role="search" method="get" id="searchform" action="<?php echo home_url( '/' ); ?>">
								<input name="s" id="s" type="text" class="search-query" autocomplete="off" placeholder="<?php _e('Search','pfk'); ?>" data-provide="typeahead" data-items="4" data-source='<?php echo $typeahead_data; ?>'>
							</form>
							<?php } ?>
